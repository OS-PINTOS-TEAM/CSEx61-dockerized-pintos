...
{
  update_advanced_priority (thread_current ());
}
...
thread_set_nice (int nice) 
{
  ...
  update_thread_advanced_priority ();
  if (t != idle_thread)
    {
...
{
  return INTO_INT_NEAREST (MUL_INT (load_avg, 100));
}
...
{
   return INTO_INT_NEAREST (MUL_INT (thread_current ()->recent_cpu,100));
}
/***********************************************************************************/
